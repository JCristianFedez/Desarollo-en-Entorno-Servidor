...
<body>
    ...
    <form action="#" method="post" class="ingredientes">
        <fieldset>
            <legend>Perrito Caliente</legend>
            ...
            <br>
            <label for="cebolla">Cebolla</label><input type="checkbox" name="cebolla" id="cebolla">
            <br>
            <label for="patata">Patata</label><input type="checkbox" name="patata" id="patata">
            <br>
    ...
    <?php
        ...
        (count($miPedido[$aP])==1)?$miPedido[$aP][1]="Solo":""; ?>
