...
<body>
    ...
    <form action="#" method="post" class="ingredientes">
        ...
        <legend>Pizza</legend>
            ...
            <br>
            <label for="jamon">Jamon</label><input type="checkbox" name="jamon" id="jamon">
            <br>
            <label for="atun">Atun</label><input type="checkbox" name="atun" id="atun">
            <br>
            <label for="bacon">Bacon</label><input type="checkbox" name="bacon" id="bacon">
            <br>
            <label for="peperoni">Peperoni</label><input type="checkbox" name="peperoni" id="peperoni">
            <br>
    ...
    <?php
        ...
        $ingredientes=["jamon","atun","bacon","peperoni"];
