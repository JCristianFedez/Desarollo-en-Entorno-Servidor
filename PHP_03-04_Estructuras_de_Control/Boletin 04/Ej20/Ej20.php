...
<body>
    ...
    if(!isset($_REQUEST["altura"])||!isset($_REQUEST["img"])){
        ...
        for ($i=0; $i < $altura; $i++) { 
            for ($j=0; $j < $altura-$i; $j++) {//Espacios izquierda
            ...
            if ($i==0) {
                ...
                echo "<img src='Imagenes\\".$img."' alt='$img'>";
                echo "<img src='Imagenes\\$img' alt='$img' class='transparente'>";//Primer espacio interior

                for ($j=1; $j < $i; $j++) {//Siguientes espacios interiores
                    echo "<img src='Imagenes\\$img' alt='$img' class='transparente'>";
                    echo "<img src='Imagenes\\$img' alt='$img' class='transparente'>";
                }
                echo "<img src='Imagenes\\".$img."' alt='$img'>";
        ...
        echo "<br><br><br><button onclick='window.location.href=\"Ej20.php\"'>Nueva Piramide</button>";
   }
    ?>
</body>
</html>